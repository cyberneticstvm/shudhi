        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('PUT', route('ward.update', $ward->id))->class('theme-form')->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label class="col-form-label pt-0 req" for="name">Ward Name </label>
                                        {{ html()->text('name', $ward->name)->class('form-control')->placeholder('Ward Name') }}
                                        @error('name')
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        {{ html()->select('localbody_id', $lbs->pluck('name', 'id'), $ward->localbody_id)->class('form-control select2')->placeholder('Select') }}
                                        @error('localbody_id')
