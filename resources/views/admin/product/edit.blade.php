        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('PUT', route('product.update', $product->id))->class('theme-form')->acceptsFiles()->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->select('category_id', $cats->pluck('name', 'id'), $product->category_id)->class('form-control')->placeholder('Select') }}
                                        @error('category_id')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->select('status', array('1' => 'Active', '0' => 'Inactive'), $product->status)->class('form-control')->placeholder('Select') }}
                                        @error('status')
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {{ html()->number('price', $product->price)->class('form-control')->placeholder('0.00') }}
                                        @error('price')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        {{ html()->textarea('description', $product->description)->class('form-control editor')->placeholder('Product Description') }}
                                        @error('description')
