            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Staff Update</li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            {{ html()->form('PUT', route('user.update', $user->id))->class('theme-form')->open() }}
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->text('mobile', $user->mobile)->class('form-control')->maxlength('10')->placeholder('Mobile') }}
                                        @error('mobile')
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        {{ html()->text('address', $user->address)->class('form-control')->maxlength('10')->placeholder('Address') }}
                                        @error('address')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ html()->select('role', array('Admin' => 'Admin', 'Staff' => 'Staff'), $user->role)->class('form-control')->placeholder('Select') }}
                                        @error('role')
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {{ html()->select('status', array('1' => 'Active', '0' => 'Inactive'), $user->status)->class('form-control')->placeholder('Select') }}
                                        @error('status')
